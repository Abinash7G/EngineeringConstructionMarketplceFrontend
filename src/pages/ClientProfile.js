...
const ClientProfile = () => {
  ...
  const handlePermanentDeleteAccount = async () => {
    try {
      await API.delete("/api/permanent-delete-account/");
      showSnackbar("Account permanently deleted successfully!", "success");
      ...
      showSnackbar("Failed to permanently delete account. Please try again.", "error");
    }
  };
