...
// // // // //   const [error, setError] = useState(null);
// // // // //   const [tabIndex, setTabIndex] = useState(0);
// // // // //   const [hasCompanyInfo, setHasCompanyInfo] = useState(false); // Track if CompanyInfo exists
...
// // // // //       // Step 1: Fetch Company model data (always exists)
...
// // // // //           companyName: companyData.company_name || "",
// // // // //           email: companyData.company_email || "",
// // // // //           address: companyData.location || "", // Map location to address
// // // // //         }));
// // // // //       }

// // // // //       // Step 2: Try fetching CompanyInfo data (may not exist for new users)
// // // // //       try {
...
// // // // //           // No CompanyInfo record exists (new user)
...
// // // // //       await fetchCompanyData(accessToken);
// // // // //     };
...
// // // // //       const formData = new FormData();
// // // // //       formData.append("company_name", company.companyName); // Required for POST
// // // // //       formData.append("company_email", company.email); // Required for POST
// // // // //       formData.append("address", company.address); // Required for POST
...
// // // // //       let response;
// // // // //       if (hasCompanyInfo) {
// // // // //         // Update existing CompanyInfo (PUT)
...
// // // // //         );
// // // // //       } else {
// // // // //         // Create new CompanyInfo (POST)
// // // // //         formData.append("company", companyId); // Link to Company model
// // // // //         response = await axios.post(
// // // // //           `http://127.0.0.1:8000/company-info/`,
// // // // //           formData,
// // // // //           {
// // // // //             headers: {
// // // // //               Authorization: `Bearer ${token}`,
...
// // // // //         setHasCompanyInfo(true); // Update state after successful creation
// // // // //       }
// // // // //     } catch (error) {
// // // // //       if (error.response?.status === 401) {
// // // // //         handleAuthError();
...
// // // // //       <Paper elevation={3} sx={{ p: 2, mb: 4, borderRadius: 2 }}>
// // // // //         <Tabs value={tabIndex} onChange={(e, newValue) => setTabIndex(newValue)} indicatorColor="primary" textColor="primary" centered>
// // // // //           <Tab label="Company Info" />
// // // // //         </Tabs>
// // // // //       </Paper>
...
// //         if (companyInfoResponse.status === 200) {
// //           setHasCompanyInfo(true);
// //           setInfoMessage(null); // Clear any info message
// //           const companyInfoData = companyInfoResponse.data;
// //           setCompany((prev) => ({
// //             ...prev,
// //             companyName: companyInfoData.company_name || prev.companyName,
...
// //         if (infoError.response?.status === 404) {
// //           setHasCompanyInfo(false);
// //           setInfoMessage("No company info available. Please fill in the details.");
// //         } else {
// //           throw infoError;
// //         }
// //       }
...
// //         setInfoMessage((prev) =>
// //           prev
// //             ? prev + " No service data available."
...
// //         alert("Company details saved successfully!");
// //         setHasCompanyInfo(true);
// //         setInfoMessage(null); // Clear info message after saving
// //       }
// //     } catch (error) {
// //       if (error.response?.status === 401) {
// //         handleAuthError();
...
// //               </Grid>
// //             ) : (
// //               <Typography sx={{ mt: 2 }}>No service data available.</Typography>
// //             )}
// //           </Paper>
// //         </Paper>
// //       )}
