...
import { Home, ShoppingCart, Favorite, AccountCircle, Logout, UploadFile, Close, Gavel, Work, ListAlt, Calculate } from "@mui/icons-material";
...
const ClientSidebar = ({ open, onClose }) => {
  ...
  const menuItems = [
    ...
    { text: "Services Inquiry", icon: <Work />, path: "/client/clientservices" },
    { text: "Agreements", icon: <Gavel />, path: "/client/agreements" },
    { text: "Order", icon: <ListAlt />, path: "/client/order" },
    { text: "Estimation & Costing", icon: <Calculate />, path: "/client/estimation-costing" },
  ];
